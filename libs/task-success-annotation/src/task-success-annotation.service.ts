...
import { TaskSuccessAnnotation, TaskSuccessAnnotationDocument } from './entity/task-success.entity';
...
export class TaskSuccessAnnotationService {
    ...
    async createTaskSuccessAnnotation(payload: CreateTaskSuccessAnnotation): Promise<any> {
        const createTaskSuccessAnnotation = new this.taskSuccessAnnotationModel(payload);
    ...
    async findCountTaskSuccessByUserId(payload: FindTaskSuccessByUserId): Promise<any> {
        const { user_id } = payload
        return await this.taskSuccessAnnotationModel.countDocuments({ user_id }).exec()
    }

    async findTaskSuccessAnnotationByProjectId(payload: FindCountTaskSuccessAnnotationByProject): Promise<any> {
    ...
    async findCountTaskSuccessAnnotationByProjectId(payload: FindCountTaskSuccessAnnotationByProject): Promise<any> {
        const { project_id } = payload
        return await this.taskSuccessAnnotationModel.countDocuments({ project_id }).exec()
    }
}
